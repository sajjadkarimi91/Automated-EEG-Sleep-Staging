...
all_hypnogram_new{14,1} = all_hypnogram{20,1};
all_hypnogram_new{14,2} = all_hypnogram{20,2};
all_hypnogram_new{20,1} = all_hypnogram{14,1};
all_hypnogram_new{20,2} = all_hypnogram{14,2};
all_hypnogram = all_hypnogram_new;

all_record_new =  all_record;
all_record_new{14,1} = all_record{20,1};
all_record_new{14,2} = all_record{20,2};
all_record_new{20,1} = all_record{14,1};
all_record_new{20,2} = all_record{14,2};
