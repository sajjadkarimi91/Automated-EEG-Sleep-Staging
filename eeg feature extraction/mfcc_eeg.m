function [ CC, FBE, frames ] = mfcc_eeg( speech, fs, Tw, Ts, alpha, window, R, M, N, L , scaling_mel )
...
%   Author: Kamil Wojcicki, September 2011
    ...
    if( nargin~= 11 ), help mfcc; return; end; 
...
%     mel2hz = @( mel )( 700*exp(mel/1127)-700 ); % mel to Hertz warping function
    ...
    hz2mel = @( hz )( 24.5*log(1+hz/14) );     % Hertz to mel warping function
    mel2hz = @( mel )( 14*exp(mel/24.5)-14 ); % mel to Hertz warping function
