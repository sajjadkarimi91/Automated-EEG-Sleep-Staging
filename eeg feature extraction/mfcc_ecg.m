function [ CC, FBE, frames ] = mfcc_ecg( speech, fs, Tw, Ts, alpha, window, R, M, N, L , scaling_mel )
...
%     mel2hz = @( mel )( 700*exp(mel/1127)-700 ); % mel to Hertz warping function
    ...
    hz2mel = @( hz )( 3.2*log(1+hz/2) );     % Hertz to mel warping function
    mel2hz = @( mel )( 2*exp(mel/3.2)-2 ); % mel to Hertz warping function
