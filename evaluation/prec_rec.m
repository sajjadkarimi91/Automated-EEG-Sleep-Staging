function [prec, tpr, fpr, thresh, auroc,auprc] = prec_rec(score, target, varargin)
% Depending on the relative class frequencies, ROC and P/R curves can highlight different properties; for details, see e.g., Davis & Goadrich,
